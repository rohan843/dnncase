...
function NamedUnpackerNode({ data: { onActivate, onActivateAndShowInPane } }) {
  return (
    <div
      onClick={() => {
      ...
      className="h-[40px] w-[50px] rounded-l-full border-2 text-white border-[#2d1e56] bg-[#6A00FF] flex items-center justify-center"
    >
